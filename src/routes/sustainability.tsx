...
export const Route = createFileRoute("/sustainability")({
  head: () => ({
    meta: [
      { title: "Sustainability — Uchi" },
      { name: "description", content: "Uchi's commitment to sustainable practices and ethical craftsmanship." },
      { property: "og:title", content: "Sustainability — Uchi" },
